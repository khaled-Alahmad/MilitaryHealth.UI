...
function EditConsultation_div_23_Template(rf, ctx) {
  if (rf & 1) {
...
function EditConsultation_span_26_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "span", 20);
  }
}
var EditConsultation = class _EditConsultation {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _EditConsultation, selectors: [["app-edit-consultation"]], inputs: { consultation: "consultation" }, outputs: { consultationUpdated: "consultationUpdated", dialogClosed: "dialogClosed" }, decls: 30, vars: 4, consts: [[1, "modal-content", "modal-lg"], [1, "modal-header", "d-flex", "justify-content-between", "align-items-center"], ["type", "button", "aria-label", "Close", 1, "btn-close", 3, "click"], [1, "modal-title", "flex-grow-1", "text-center"], [1, "modal-body"], [3, "ngSubmit", "formGroup"], ["type", "hidden", "formControlName", "consultationType"], [1, "mb-3"], [1, "form-label"], [1, "pi", "pi-info-circle", "me-2"], ["formControlName", "referralReason", "placeholder", "\u0623\u062F\u062E\u0644 \u0633\u0628\u0628 \u0627\u0644\u0625\u062D\u0627\u0644\u0629 (\u0627\u062E\u062A\u064A\u0627\u0631\u064A)", "rows", "3", 1, "form-control"], ["formControlName", "result", "placeholder", "\u0623\u062F\u062E\u0644 \u0627\u0644\u0646\u062A\u064A\u062C\u0629", 1, "form-control"], ["type", "file", "accept", "image/*", 1, "form-control", 3, "change"], ["class", "preview-container mt-3", 4, "ngIf"], [1, "modal-footer", "d-flex", "gap-2", "justify-content-end"], ["type", "submit", 1, "btn", "btn-success", 3, "disabled"], ["class", "spinner-border spinner-border-sm", 4, "ngIf"], ["type", "button", 1, "btn", "btn-secondary", 3, "click"], [1, "preview-container", "mt-3"], ["alt", "\u0645\u0639\u0627\u064A\u0646\u0629 \u0627\u0644\u0645\u0631\u0641\u0642", 1, "img-fluid", "rounded", 2, "max-height", "200px", 3, "src"], [1, "spinner-border", "spinner-border-sm"]], template: function EditConsultation_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275text(5, "\u0625\u0636\u0627\u0641\u0629 \u0646\u062A\u064A\u062C\u0629 \u0644\u0644\u0627\u0633\u062A\u0634\u0627\u0631\u0629");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(6, "div", 4)(7, "form", 5);
      \u0275\u0275listener("ngSubmit", function EditConsultation_Template_form_ngSubmit_7_listener() {
        return ctx.onSubmit();
      });
      \u0275\u0275element(8, "input", 6);
      \u0275\u0275elementStart(9, "div", 7)(10, "label", 8);
      \u0275\u0275element(11, "i", 9);
      \u0275\u0275text(12, " \u0633\u0628\u0628 \u0627\u0644\u0625\u062D\u0627\u0644\u0629 ");
      \u0275\u0275elementEnd();
      ...
      \u0275\u0275listener("change", function EditConsultation_Template_input_change_22_listener($event) {
        return ctx.onFileSelected($event);
      });
      \u0275\u0275elementEnd();
      \u0275\u0275template(23, EditConsultation_div_23_Template, 2, 1, "div", 13);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(24, "div", 14)(25, "button", 15);
      \u0275\u0275template(26, EditConsultation_span_26_Template, 1, 0, "span", 16);
      \u0275\u0275text(27, " \u062D\u0641\u0638 \u0627\u0644\u062A\u0639\u062F\u064A\u0644 ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(28, "button", 17);
      \u0275\u0275listener("click", function EditConsultation_Template_button_click_28_listener() {
        return ctx.cancel();
      });
      \u0275\u0275text(29, "\u0625\u0644\u063A\u0627\u0621");
      \u0275\u0275elementEnd()()()()();
...
//# sourceMappingURL=chunk-JEPGTHKH.js.map
