...
var BarcodePrintService = class _BarcodePrintService {
  datePipe;
  constructor() {
  ...
  printBarcodeReceipt(applicant) {
    return __async(this, null, function* () {
      try {
        ...
        const qrCodeDataUrl = yield QRCode.toDataURL(qrCodeData, {
          width: 200,
          margin: 1,
   ...
   * إنشاء HTML للإيصال
   */
  generateReceiptHTML(applicant, qrCodeDataUrl, qrCodeData) {
    return `
<!DOCTYPE html>
...
<body>
  ...
  static \u0275fac = function BarcodePrintService_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _BarcodePrintService)();
  };
  static \u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _BarcodePrintService, factory: _BarcodePrintService.\u0275fac, providedIn: "root" });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(BarcodePrintService, [{
    type: Injectable,
    args: [{
      providedIn: "root"
    }]
...
//# sourceMappingURL=chunk-PHTDGWVA.js.map
