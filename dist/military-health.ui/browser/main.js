...
var routes = [
  {
    path: "login",
    loadComponent: () => import("./chunk-4BIEVPTJ.js").then((m5) => m5.Login)
  },
  { path: "unauthorized", component: Unauthorized },
  {
    path: "",
    loadComponent: () => import("./chunk-MEMUDUY3.js").then((m5) => m5.Layout),
    canActivate: [authGuard],
    children: [
      {
        path: "admin",
        loadChildren: () => import("./chunk-BNALSKLS.js").then((m5) => m5.ADMIN_ROUTES),
        canActivate: [authGuard],
      ...
      },
      {
        ...
        loadComponent: () => import("./chunk-W63CAJ26.js").then((m5) => m5.ApplicantProfile)
      },
      {
        path: "reception",
      ...
      {
        path: "archive",
        loadChildren: () => import("./chunk-BPP2Y555.js").then((m5) => m5.Archive_ROUTES),
...
(() => {
  ...
  `, styles: ["/* angular:styles/component:scss;e7f9682667e30aff8f592675aac7a84e8ddb3a05b6effdddee4b6344cea74734;C:/Users/OmarAlebrahim/OneDrive/\u0633\u0637\u062D \u0627\u0644\u0645\u0643\u062A\u0628/MilitaryHealth.UI/src/app/shared/components/scroll-to-top/scroll-to-top.component.ts */\n.scroll-to-top {\n  position: fixed;\n  bottom: 2rem;\n  left: 2rem;\n  width: 3rem;\n  height: 3rem;\n  background:\n    linear-gradient(\n      135deg,\n      var(--primary-dark) 0%,\n      var(--primary-medium) 100%);\n  color: white;\n  border: none;\n  border-radius: 50%;\n  cursor: pointer;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  box-shadow: var(--shadow-lg);\n  transition: all var(--transition-normal);\n  z-index: 1000;\n  opacity: 0;\n  visibility: hidden;\n  transform: translateY(20px);\n}\n.scroll-to-top.visible {\n  opacity: 1;\n  visibility: visible;\n  transform: translateY(0);\n}\n.scroll-to-top:hover {\n  transform: translateY(-5px);\n  box-shadow: var(--shadow-xl);\n  background:\n    linear-gradient(\n      135deg,\n      var(--primary-medium) 0%,\n      var(--primary-dark) 100%);\n}\n.scroll-to-top i {\n  font-size: var(--font-size-xl);\n}\n/*# sourceMappingURL=scroll-to-top.component.css.map */\n"] }]
