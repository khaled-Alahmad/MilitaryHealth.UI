...
function SurgeryInvestigationsList_ng_template_7_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "tr")(1, "th", 11);
    \u0275\u0275text(2, "\u0631\u0642\u0645 \u0627\u0644\u0645\u0644\u0641");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "th", 11);
...
function SurgeryInvestigationsList_ng_template_8_Conditional_14_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 21);
    \u0275\u0275listener("click", function SurgeryInvestigationsList_ng_template_8_Conditional_14_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r3);
...
function SurgeryInvestigationsList_ng_template_8_Conditional_15_Template(rf, ctx) {
  if (rf & 1) {
...
function SurgeryInvestigationsList_ng_template_8_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(14, SurgeryInvestigationsList_ng_template_8_Conditional_14_Template, 3, 0, "button", 18)(15, SurgeryInvestigationsList_ng_template_8_Conditional_15_Template, 2, 0, "span");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(16, "td", 17)(17, "button", 19);
    \u0275\u0275listener("click", function SurgeryInvestigationsList_ng_template_8_Template_button_click_17_listener() {
...
function SurgeryInvestigationsList_ng_template_9_Template(rf, ctx) {
  if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(SurgeryInvestigationsList, [{
    type: Component,
    args: [{ selector: "app-surgery-investigations-list", standalone: true, imports: [CommonModule, ButtonModule, FormsModule, TableModule, PaginatorComponent, FilterBarComponent, PageHeaderComponent], template: `<div class="list-page-section">\r
  <app-page-header\r
    variant="banner"\r
    title="\u0627\u0633\u062A\u0642\u0635\u0627\u0621\u0627\u062A \u0627\u0644\u0639\u064A\u0627\u062F\u0629 \u0627\u0644\u062C\u0631\u0627\u062D\u064A\u0629"\r
...
\r
  <p-table\r
    ...
    <ng-template pTemplate="header">\r
      <tr>\r
        <th style="width: 120px">\u0631\u0642\u0645 \u0627\u0644\u0645\u0644\u0641</th>\r
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SurgeryInvestigationsList, { className: "SurgeryInvestigationsList", filePath: "src/app/features/doctor/components/surgery-doctor.component/surgery-investigations-list/surgery-investigations-list.ts", lineNumber: 23 });
})();
export {
  SurgeryInvestigationsList
};
//# sourceMappingURL=chunk-W2QIIFAC.js.map
