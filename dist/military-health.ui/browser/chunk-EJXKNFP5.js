...
var _c0 = ["table"];
var _c1 = ["searchInput"];
function InternalInvestigationsList_ng_template_10_Template(rf, ctx) {
  if (rf & 1) {
...
function InternalInvestigationsList_ng_template_11_Conditional_15_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 19);
    \u0275\u0275listener("click", function InternalInvestigationsList_ng_template_11_Conditional_15_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r3);
...
function InternalInvestigationsList_ng_template_11_Conditional_16_Template(rf, ctx) {
  if (rf & 1) {
...
function InternalInvestigationsList_ng_template_11_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(15, InternalInvestigationsList_ng_template_11_Conditional_15_Template, 3, 0, "button", 15)(16, InternalInvestigationsList_ng_template_11_Conditional_16_Template, 2, 0, "span");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(17, "td", 16)(18, "button", 17);
    \u0275\u0275listener("click", function InternalInvestigationsList_ng_template_11_Template_button_click_18_listener() {
...
var InternalInvestigationsList = class _InternalInvestigationsList {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _InternalInvestigationsList, selectors: [["app-internal-investigations-list"]], viewQuery: function InternalInvestigationsList_Query(rf, ctx) {
    ...
    if (rf & 1) {
      ...
      \u0275\u0275template(10, InternalInvestigationsList_ng_template_10_Template, 17, 0, "ng-template", 10)(11, InternalInvestigationsList_ng_template_11_Template, 21, 8, "ng-template", 11)(12, InternalInvestigationsList_ng_template_12_Template, 3, 0, "ng-template", 12);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(13, "app-paginator", 13);
      \u0275\u0275listener("pageChange", function InternalInvestigationsList_Template_app_paginator_pageChange_13_listener($event) {
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView(ctx.onPageChange($event));
      })("pageSizeChange", function InternalInvestigationsList_Template_app_paginator_pageSizeChange_13_listener($event) {
        \u0275\u0275restoreView(_r1);
...
\r
  ...
  <p-table #table [value]="filteredInvestigations" [rows]="rowsPerPage" [scrollable]="true" [showCurrentPageReport]="true"\r
  class="custom-table">\r
    ...
    <ng-template pTemplate="body" let-i>\r
      <tr>\r
        ...
        <td>{{ i.result || '-' }}</td>\r
        <td>\r
          <span [ngClass]="getBadgeClass(i.status)">{{ i.status || '-' }}</span>\r
        </td>\r
        ...
        <td>\r
          ...
          <button type="button" class="btn btn-sm btn-outline-secondary" title="\u0641\u062A\u062D \u0627\u0644\u0645\u0644\u0641"\r
            ...
            <i class="bi bi-file-earmark-text me-1 bx"></i>\r
            \u0641\u062A\u062D \u0627\u0644\u0645\u0644\u0641\r
          </button>\r
          }@else {\r
...
\r
        ...
        <td class="text-center">\r
          ...
          <!-- <button type="button" class="btn btn-sm btn-primary" title="\u0627\u0636\u0627\u0641\u0629 \u0646\u062A\u064A\u062C\u0629" (click)="openEditInvestigation(i)">\r
            <i class="bi bi-pencil-square me-1 bx"></i>\r
            \u0627\u0636\u0627\u0641\u0629 \u0646\u062A\u064A\u062C\u0629\r
          </button> -->\r
        </td>\r
      </tr>\r
...
\r
  <!-- \u0645\u0648\u062F\u0627\u0644 \u0627\u0644\u062A\u0639\u062F\u064A\u0644 -->\r
  <!-- \u0645\u0648\u062F\u0627\u0644 \u0627\u0644\u062A\u0639\u062F\u064A\u0644 -->\r
  <!-- <app-edit-investigation \r
    *ngIf="selectedInvestigation" \r
    [investigation]="selectedInvestigation" \r
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(InternalInvestigationsList, { className: "InternalInvestigationsList", filePath: "src/app/features/doctor/components/internal-doctor.component/internal-investigations-list/internal-investigations-list.ts", lineNumber: 21 });
})();
export {
  InternalInvestigationsList
};
//# sourceMappingURL=chunk-EJXKNFP5.js.map
