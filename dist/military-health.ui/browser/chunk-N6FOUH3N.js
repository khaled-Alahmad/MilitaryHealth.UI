...
function D(t, e, o = true) {
  var n, r, i2, l2;
  if (t) {
    let d2 = t.offsetParent ? { width: t.offsetWidth, height: t.offsetHeight } : w(t), s3 = d2.height, a2 = d2.width, u = e.offsetHeight, p2 = e.offsetWidth, f = e.getBoundingClientRect(), g2 = $(), it = k(), lt = h(), L, N3, ot = "top";
    f.top + u + s3 > lt.height ? (L = f.top + g2 - s3, ot = "bottom", L < 0 && (L = g2)) : L = u + f.top + g2, f.left + a2 > lt.width ? N3 = Math.max(0, f.left + it + p2 - a2) : N3 = f.left + it, V(t) ? t.style.insetInlineEnd = N3 + "px" : t.style.insetInlineStart = N3 + "px", t.style.top = L + "px", t.style.transformOrigin = ot, o && (t.style.marginTop = ot === "bottom" ? `calc(${(r = (n = x(/-anchor-gutter$/)) == null ? void 0 : n.value) != null ? r : "2px"} * -1)` : (l2 = (i2 = x(/-anchor-gutter$/)) == null ? void 0 : i2.value) != null ? l2 : "");
  }
}
function S(t, e) {
...
var d = (e, t) => {
  ...
  if (K2) for (var n of K2(t)) ae.call(t, n) && N(e, n, t[n]);
  return e;
};
function l(e) {
  ...
  for (; o.length; ) {
    ...
    for (let u in m2) {
      ...
      if (i(f)) o.push({ node: f, path: p2 });
        ...
        let y3 = ae2(p2), R2 = Y3(f, p2, s3, [a2]);
        Re(l2, y3, R2);
        let T2 = p2;
...
var b3 = { regex: { rules: { class: { pattern: /^\.([a-zA-Z][\w-]*)$/, resolve(e) {
  ...
  if (s2(a2) && n.transform !== "strict") {
    ...
    d2 = `${et2}${tt}`, u = [.../* @__PURE__ */ new Set([...We, ...Ze, ...Je])], g2 = m(a2.css, { dt: E2 });
  }
  ...
  if (s2(t) && r.transform !== "strict") {
    let y3 = e.replace("-directive", ""), m2 = t, { colorScheme: R2, extend: T2, css: j2 } = m2, O2 = v2(m2, ["colorScheme", "extend", "css"]), d2 = T2 || {}, { colorScheme: M2 } = d2, z3 = v2(d2, ["colorScheme"]), u = R2 || {}, { dark: V2 } = u, L = v2(u, ["dark"]), g2 = M2 || {}, { dark: te } = g2, re2 = v2(g2, ["dark"]), K3 = s2(O2) ? this._toVariables({ [y3]: h2(h2({}, O2), z3) }, r) : {}, A2 = s2(L) ? this._toVariables({ [y3]: h2(h2({}, L), re2) }, r) : {}, X2 = s2(V2) ? this._toVariables({ [y3]: h2(h2({}, V2), te) }, r) : {}, [G2, U2] = [(f = K3.declarations) != null ? f : "", K3.tokens || []], [B, I2] = [(x2 = A2.declarations) != null ? x2 : "", A2.tokens || []], [H2, W2] = [(p2 = X2.declarations) != null ? p2 : "", X2.tokens || []], q2 = this.transformCSS(y3, `${G2}${B}`, "light", "variable", r, i2, a2, n), Z = this.transformCSS(y3, H2, "dark", "variable", r, i2, a2, n);
  ...
  if (s2(t)) {
    ...
    if (s3 !== "style") {
      ...
      t = r === "dark" ? c3.reduce((m2, { type: d2, selector: u }) => (s2(u) && (m2 += u.includes("[CSS]") ? u.replace("[CSS]", t) : this.getSelectorRule(u, l2, d2, t)), m2), "") : C3(l2 != null ? l2 : ":root,:host", t);
    }
    if (o) {
...
var S2 = { defaults: { variable: { prefix: "p", selector: ":root,:host", excludedKeyRegex: /^(primitive|semantic|components|directives|variables|colorscheme|light|dark|common|root|states|extend|css)$/gi }, options: { prefix: "p", darkModeSelector: "system", cssLayer: false } }, _theme: void 0, _layerNames: /* @__PURE__ */ new Set(), _loadedStyleNames: /* @__PURE__ */ new Set(), _loadingStyles: /* @__PURE__ */ new Set(), _tokens: {}, update(e = {}) {
  let { theme: t } = e;
  t && (this._theme = $3(h2({}, t), { options: h2(h2({}, this.defaults.options), t.options) }), this._tokens = b3.createTokens(this.preset, this.defaults), this.clearLoadedStyleNames());
}, get theme() {
  return this._theme;
}, get preset() {
  var e;
...
//# sourceMappingURL=chunk-N6FOUH3N.js.map
