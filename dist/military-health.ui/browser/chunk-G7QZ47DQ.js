...
function OrthopedicInvestigationsList_ng_template_7_Template(rf, ctx) {
  if (rf & 1) {
...
function OrthopedicInvestigationsList_ng_template_8_Conditional_20_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 22);
    \u0275\u0275listener("click", function OrthopedicInvestigationsList_ng_template_8_Conditional_20_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r3);
...
function OrthopedicInvestigationsList_ng_template_8_Conditional_21_Template(rf, ctx) {
  if (rf & 1) {
...
function OrthopedicInvestigationsList_ng_template_8_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(20, OrthopedicInvestigationsList_ng_template_8_Conditional_20_Template, 3, 0, "button", 19)(21, OrthopedicInvestigationsList_ng_template_8_Conditional_21_Template, 2, 0, "span");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(22, "td", 18)(23, "button", 20);
    \u0275\u0275listener("click", function OrthopedicInvestigationsList_ng_template_8_Template_button_click_23_listener() {
...
function OrthopedicInvestigationsList_ng_template_9_Template(rf, ctx) {
  if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(OrthopedicInvestigationsList, [{
    type: Component,
    args: [{ selector: "app-orthopedic-investigations-list", imports: [CommonModule, ButtonModule, FormsModule, TableModule, PaginatorComponent, FilterBarComponent, PageHeaderComponent], template: `<div class="list-page-section">\r
  <app-page-header\r
    variant="banner"\r
    title="\u0627\u0633\u062A\u0642\u0635\u0627\u0621\u0627\u062A \u0627\u0644\u0639\u064A\u0627\u062F\u0629 \u0627\u0644\u0639\u0638\u0645\u064A\u0629"\r
  ...
  <p-table\r
    ...
    <ng-template pTemplate="body" let-i>\r
      <tr>\r
        ...
        <td><span [ngClass]="getBadgeClass(i.status)" class="small">{{ i.status || '-' }}</span></td>\r
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(OrthopedicInvestigationsList, { className: "OrthopedicInvestigationsList", filePath: "src/app/features/doctor/components/orthopedics-doctor.component/orthopedic-investigations-list/orthopedic-investigations-list.ts", lineNumber: 22 });
})();
export {
  OrthopedicInvestigationsList
};
//# sourceMappingURL=chunk-G7QZ47DQ.js.map
