...
function EyeInvestigationsList_ng_template_7_Template(rf, ctx) {
  if (rf & 1) {
...
function EyeInvestigationsList_ng_template_8_Conditional_17_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 21);
    \u0275\u0275listener("click", function EyeInvestigationsList_ng_template_8_Conditional_17_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r3);
...
function EyeInvestigationsList_ng_template_8_Conditional_18_Template(rf, ctx) {
  if (rf & 1) {
...
function EyeInvestigationsList_ng_template_8_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(17, EyeInvestigationsList_ng_template_8_Conditional_17_Template, 3, 0, "button", 18)(18, EyeInvestigationsList_ng_template_8_Conditional_18_Template, 2, 0, "span");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(19, "td", 17)(20, "button", 19);
    \u0275\u0275listener("click", function EyeInvestigationsList_ng_template_8_Template_button_click_20_listener() {
...
function EyeInvestigationsList_ng_template_9_Template(rf, ctx) {
  if (rf & 1) {
...
var EyeInvestigationsList = class _EyeInvestigationsList {
  ...
  }, dependencies: [CommonModule, ButtonModule, PrimeTemplate, FormsModule, TableModule, Table, PaginatorComponent, FilterBarComponent, PageHeaderComponent], styles: ["\n\n.table-toolbar[_ngcontent-%COMP%] {\n  margin-bottom: var(--spacing-md);\n  padding: 0.75rem;\n  border: 1px solid #e7edf3;\n  border-radius: var(--border-radius-md);\n  background:\n    linear-gradient(\n      135deg,\n      #f9fbff 0%,\n      #f2f7ff 100%);\n  display: flex;\n  justify-content: flex-end;\n  direction: rtl;\n}\n.table-toolbar__filter[_ngcontent-%COMP%] {\n  margin-top: 0;\n  width: min(100%, 560px) !important;\n  margin-left: auto !important;\n  margin-right: 0 !important;\n  flex: 0 0 auto;\n}\n.table-toolbar__filter[_ngcontent-%COMP%]   .eye-filter-bar[_ngcontent-%COMP%] {\n  display: block;\n  width: 100%;\n}\n@media (max-width: 768px) {\n  .table-toolbar[_ngcontent-%COMP%] {\n    padding: 0.65rem;\n  }\n  .table-toolbar__filter[_ngcontent-%COMP%] {\n    width: 100%;\n    margin-left: 0 !important;\n  }\n}\n[_nghost-%COMP%] {\n  display: block;\n}\n.user-header-section[_ngcontent-%COMP%] {\n  background: #fff;\n  border: 1px solid #e9ecef;\n  border-radius: var(--border-radius-md);\n  box-shadow: var(--shadow-sm);\n  padding: var(--spacing-md);\n  margin: 0 auto var(--spacing-md);\n}\n.custom-table[_ngcontent-%COMP%] {\n  direction: rtl;\n}\n.btn.btn-sm[_ngcontent-%COMP%] {\n  border-radius: 8px;\n}\n/*# sourceMappingURL=eye-investigations-list.css.map */"] });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(EyeInvestigationsList, [{
    type: Component,
    args: [{ selector: "app-eye-investigations-list", standalone: true, imports: [CommonModule, ButtonModule, FormsModule, TableModule, PaginatorComponent, FilterBarComponent, PageHeaderComponent], template: `<div class="user-header-section px-1 pt-1 container-fluid">\r
  <app-page-header\r
    variant="banner"\r
    title="\u0627\u0633\u062A\u0642\u0635\u0627\u0621\u0627\u062A \u0627\u0644\u0639\u064A\u0627\u062F\u0629 \u0627\u0644\u0639\u064A\u0646\u064A\u0629"\r
...
`, styles: ["/* src/app/features/doctor/components/eye-doctor.component/eye-investigations-list/eye-investigations-list.scss */\n.table-toolbar {\n  margin-bottom: var(--spacing-md);\n  padding: 0.75rem;\n  border: 1px solid #e7edf3;\n  border-radius: var(--border-radius-md);\n  background:\n    linear-gradient(\n      135deg,\n      #f9fbff 0%,\n      #f2f7ff 100%);\n  display: flex;\n  justify-content: flex-end;\n  direction: rtl;\n}\n.table-toolbar__filter {\n  margin-top: 0;\n  width: min(100%, 560px) !important;\n  margin-left: auto !important;\n  margin-right: 0 !important;\n  flex: 0 0 auto;\n}\n.table-toolbar__filter .eye-filter-bar {\n  display: block;\n  width: 100%;\n}\n@media (max-width: 768px) {\n  .table-toolbar {\n    padding: 0.65rem;\n  }\n  .table-toolbar__filter {\n    width: 100%;\n    margin-left: 0 !important;\n  }\n}\n:host {\n  display: block;\n}\n.user-header-section {\n  background: #fff;\n  border: 1px solid #e9ecef;\n  border-radius: var(--border-radius-md);\n  box-shadow: var(--shadow-sm);\n  padding: var(--spacing-md);\n  margin: 0 auto var(--spacing-md);\n}\n.custom-table {\n  direction: rtl;\n}\n.btn.btn-sm {\n  border-radius: 8px;\n}\n/*# sourceMappingURL=eye-investigations-list.css.map */\n"] }]
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(EyeInvestigationsList, { className: "EyeInvestigationsList", filePath: "src/app/features/doctor/components/eye-doctor.component/eye-investigations-list/eye-investigations-list.ts", lineNumber: 25 });
})();
export {
  EyeInvestigationsList
};
//# sourceMappingURL=chunk-KRNM5SJN.js.map
