...
function EditEarConsultationComponent_option_27_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("value", r_r1.description);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", r_r1.description, " ");
  }
}
function EditEarConsultationComponent_div_28_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function EditEarConsultationComponent_div_28_Template_button_click_4_listener() {
      \u0275\u0275restoreView(_r2);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.openFile(ctx_r2.consultation.attachment));
    });
    \u0275\u0275element(5, "i", 27);
    \u0275\u0275text(6, " \u0639\u0631\u0636 \u0627\u0644\u0645\u0644\u0641 ");
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance(8);
    \u0275\u0275textInterpolate(ctx_r2.consultation.attachment);
  }
}
function EditEarConsultationComponent_div_35_Template(rf, ctx) {
  if (rf & 1) {
...
function EditEarConsultationComponent_span_40_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "span", 31);
  }
}
var EditEarConsultationComponent = class _EditEarConsultationComponent {
  fb;
  service;
  authService;
  toastr;
  ...
  static \u0275fac = function EditEarConsultationComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _EditEarConsultationComponent)(\u0275\u0275directiveInject(FormBuilder), \u0275\u0275directiveInject(EarClinicExamService), \u0275\u0275directiveInject(AuthService), \u0275\u0275directiveInject(ToastrService), \u0275\u0275directiveInject(NgbActiveModal));
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _EditEarConsultationComponent, selectors: [["app-edit-ear-consultation"]], inputs: { consultation: "consultation" }, outputs: { consultationUpdated: "consultationUpdated", dialogClosed: "dialogClosed" }, decls: 42, vars: 9, consts: [[1, "modal-header"], [1, "modal-title"], ["type", "button", 1, "btn-close", 3, "click"], [1, "modal-body"], [3, "ngSubmit", "formGroup"], [1, "row"], [1, "col-md-6", "mb-3"], [1, "form-label"], ["type", "text", "readonly", "", 1, "form-control", 3, "value"], [1, "col-md-12", "mb-3"], [1, "pi", "pi-info-circle", "me-2"], ["formControlName", "referralReason", "rows", "3", "placeholder", "\u0623\u062F\u062E\u0644 \u0633\u0628\u0628 \u0627\u0644\u0625\u062D\u0627\u0644\u0629 (\u0627\u062E\u062A\u064A\u0627\u0631\u064A)", 1, "form-control"], [1, "text-danger"], ["formControlName", "result", 1, "form-select"], [3, "value", 4, "ngFor", "ngForOf"], ["class", "col-12 mb-3", 4, "ngIf"], [1, "col-12", "mb-3"], ["type", "file", "accept", "image/*,.pdf,.doc,.docx", 1, "form-control", 3, "change"], [1, "form-text"], ["class", "preview-container mt-3", 4, "ngIf"], [1, "modal-footer"], ["type", "button", 1, "btn", "btn-secondary", 3, "click"], ["type", "button", 1, "btn", "btn-primary", 3, "click", "disabled"], ["class", "spinner-border spinner-border-sm me-2", 4, "ngIf"], [3, "value"], [1, "d-flex", "align-items-center"], ["type", "button", 1, "btn", "btn-outline-primary", "btn-sm", "me-2", 3, "click"], [1, "pi", "pi-download", "me-1"], [1, "text-muted", "small"], [1, "preview-container", "mt-3"], ["alt", "\u0645\u0639\u0627\u064A\u0646\u0629 \u0627\u0644\u0645\u0631\u0641\u0642", 1, "img-fluid", "rounded", 2, "max-height", "200px", 3, "src"], [1, "spinner-border", "spinner-border-sm", "me-2"]], template: function EditEarConsultationComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "div", 0)(1, "h4", 1);
      \u0275\u0275text(2, "\u0625\u0636\u0627\u0641\u0629 \u0646\u062A\u064A\u062C\u0629 \u0644\u0644\u0627\u0633\u062A\u0634\u0627\u0631\u0629");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(3, "button", 2);
      \u0275\u0275listener("click", function EditEarConsultationComponent_Template_button_click_3_listener() {
        return ctx.onCancel();
      });
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(4, "div", 3)(5, "form", 4);
      \u0275\u0275listener("ngSubmit", function EditEarConsultationComponent_Template_form_ngSubmit_5_listener() {
        return ctx.onSubmit();
      });
      ...
      \u0275\u0275text(13, "\u0646\u0648\u0639 \u0627\u0644\u0627\u0633\u062A\u0634\u0627\u0631\u0629");
      \u0275\u0275elementEnd();
      \u0275\u0275element(14, "input", 8);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(15, "div", 9)(16, "label", 7);
      \u0275\u0275element(17, "i", 10);
      \u0275\u0275text(18, " \u0633\u0628\u0628 \u0627\u0644\u0625\u062D\u0627\u0644\u0629 ");
      \u0275\u0275elementEnd();
      ...
      \u0275\u0275template(27, EditEarConsultationComponent_option_27_Template, 2, 2, "option", 14);
      \u0275\u0275elementEnd()();
      \u0275\u0275template(28, EditEarConsultationComponent_div_28_Template, 9, 1, "div", 15);
      \u0275\u0275elementStart(29, "div", 16)(30, "label", 7);
      \u0275\u0275text(31, "\u0631\u0641\u0639 \u0645\u0644\u0641 \u062C\u062F\u064A\u062F (\u0627\u062E\u062A\u064A\u0627\u0631\u064A)");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(32, "input", 17);
      \u0275\u0275listener("change", function EditEarConsultationComponent_Template_input_change_32_listener($event) {
        return ctx.onFileSelected($event);
      });
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(33, "div", 18);
      \u0275\u0275text(34, "\u064A\u0645\u0643\u0646\u0643 \u0631\u0641\u0639 \u0645\u0644\u0641\u0627\u062A PDF\u060C Word\u060C \u0623\u0648 \u0627\u0644\u0635\u0648\u0631");
      \u0275\u0275elementEnd();
      \u0275\u0275template(35, EditEarConsultationComponent_div_35_Template, 2, 1, "div", 19);
      \u0275\u0275elementEnd()()()();
      \u0275\u0275elementStart(36, "div", 20)(37, "button", 21);
      \u0275\u0275listener("click", function EditEarConsultationComponent_Template_button_click_37_listener() {
        return ctx.onCancel();
      });
      \u0275\u0275text(38, "\u0625\u0644\u063A\u0627\u0621");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(39, "button", 22);
      \u0275\u0275listener("click", function EditEarConsultationComponent_Template_button_click_39_listener() {
        return ctx.onSubmit();
      });
      \u0275\u0275template(40, EditEarConsultationComponent_span_40_Template, 1, 0, "span", 23);
      \u0275\u0275text(41);
      \u0275\u0275elementEnd()();
    }
    if (rf & 2) {
      ...
      \u0275\u0275advance(5);
      \u0275\u0275property("value", ctx.consultation.applicantFileNumber);
      \u0275\u0275advance(4);
      \u0275\u0275property("value", ctx.consultation.consultationType);
      \u0275\u0275advance(13);
      \u0275\u0275property("ngForOf", ctx.results);
      \u0275\u0275advance();
      \u0275\u0275property("ngIf", ctx.consultation.attachment);
      \u0275\u0275advance(7);
      \u0275\u0275property("ngIf", ctx.previewUrl && ctx.previewUrl.startsWith("data:"));
      \u0275\u0275advance(4);
      \u0275\u0275property("disabled", ctx.loading || ctx.consultationForm.invalid);
      \u0275\u0275advance();
...
/*# sourceMappingURL=edit-ear-consultation.css.map */`] });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(EditEarConsultationComponent, [{
    type: Component,
    args: [{ selector: "app-edit-ear-consultation", standalone: true, imports: [CommonModule, ReactiveFormsModule], template: `<div class="modal-header">\r
  <h4 class="modal-title">\u0625\u0636\u0627\u0641\u0629 \u0646\u062A\u064A\u062C\u0629 \u0644\u0644\u0627\u0633\u062A\u0634\u0627\u0631\u0629</h4>\r
  <button type="button" class="btn-close" (click)="onCancel()"></button>\r
</div>\r
\r
<div class="modal-body">\r
  <form [formGroup]="consultationForm" (ngSubmit)="onSubmit()">\r
    <div class="row">\r
      <!-- \u0645\u0639\u0644\u0648\u0645\u0627\u062A \u0627\u0644\u0627\u0633\u062A\u0634\u0627\u0631\u0629 (\u0644\u0644\u0639\u0631\u0636 \u0641\u0642\u0637) -->\r
      <div class="col-md-6 mb-3">\r
        <label class="form-label">\u0631\u0642\u0645 \u0645\u0644\u0641 \u0627\u0644\u0645\u0631\u064A\u0636</label>\r
        <input type="text" class="form-control" [value]="consultation.applicantFileNumber" readonly>\r
      </div>\r
\r
      <div class="col-md-6 mb-3">\r
        <label class="form-label">\u0646\u0648\u0639 \u0627\u0644\u0627\u0633\u062A\u0634\u0627\u0631\u0629</label>\r
        <input type="text" class="form-control" [value]="consultation.consultationType" readonly>\r
      </div>\r
\r
...
\r
      ...
      <div class="col-md-6 mb-3">\r
        ...
        <select class="form-select" formControlName="result">\r
          <option *ngFor="let r of results" [value]="r.description">\r
            {{ r.description }}\r
          </option>\r
        </select>\r
      </div>\r
\r
      <!-- \u0627\u0644\u0645\u0631\u0641\u0642 \u0627\u0644\u062D\u0627\u0644\u064A -->\r
      <div class="col-12 mb-3" *ngIf="consultation.attachment">\r
        <label class="form-label">\u0627\u0644\u0645\u0644\u0641 \u0627\u0644\u0645\u0631\u0641\u0642 \u0627\u0644\u062D\u0627\u0644\u064A</label>\r
        <div class="d-flex align-items-center">\r
          <button type="button" class="btn btn-outline-primary btn-sm me-2" (click)="openFile(consultation.attachment)">\r
            <i class="pi pi-download me-1"></i>\r
            \u0639\u0631\u0636 \u0627\u0644\u0645\u0644\u0641\r
          </button>\r
          <span class="text-muted small">{{ consultation.attachment }}</span>\r
        </div>\r
      </div>\r
\r
      <!-- \u0631\u0641\u0639 \u0645\u0644\u0641 \u062C\u062F\u064A\u062F -->\r
...
<div class="modal-footer">\r
  ...
  <button type="button" class="btn btn-primary" (click)="onSubmit()" [disabled]="loading || consultationForm.invalid">\r
...
/* src/app/features/doctor/components/ear-doctor.component/edit-ear-consultation/edit-ear-consultation.scss */
.modal-backdrop {
  position: fixed;
  inset: 0;
  background: rgba(0, 0, 0, 0.7);
...
/*# sourceMappingURL=edit-ear-consultation.css.map */
`] }]
  }], () => [{ type: FormBuilder }, { type: EarClinicExamService }, { type: AuthService }, { type: ToastrService }, { type: NgbActiveModal }], { consultation: [{
    type: Input
  }], consultationUpdated: [{
    type: Output
  }], dialogClosed: [{
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(EditEarConsultationComponent, { className: "EditEarConsultationComponent", filePath: "src/app/features/doctor/components/ear-doctor.component/edit-ear-consultation/edit-ear-consultation.ts", lineNumber: 17 });
})();

// src/app/features/doctor/components/ear-doctor.component/ear-consultations-list/ear-consultations-list.ts
var _c0 = ["table"];
var _c1 = ["searchInput"];
var _c2 = () => ({ "min-width": "50rem" });
function EarConsultationsList_ng_template_12_Template(rf, ctx) {
  if (rf & 1) {
...
function EarConsultationsList_ng_template_13_Conditional_17_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 25);
    \u0275\u0275listener("click", function EarConsultationsList_ng_template_13_Conditional_17_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r3);
      const consultation_r4 = \u0275\u0275nextContext().$implicit;
      const ctx_r4 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r4.openFile(consultation_r4.attachment));
    });
    \u0275\u0275element(1, "i", 26);
    \u0275\u0275text(2, " \u0641\u062A\u062D \u0627\u0644\u0645\u0644\u0641 ");
    \u0275\u0275elementEnd();
...
function EarConsultationsList_ng_template_13_Conditional_18_Template(rf, ctx) {
  if (rf & 1) {
...
function EarConsultationsList_ng_template_13_Template(rf, ctx) {
  if (rf & 1) {
    const _r2 = \u0275\u0275getCurrentView();
    ...
    \u0275\u0275text(6);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(7, "td", 18)(8, "span", 20);
    \u0275\u0275text(9);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(10, "td", 18)(11, "span");
    \u0275\u0275text(12);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(13, "td", 18)(14, "span", 20);
    \u0275\u0275text(15);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(16, "td", 18);
    \u0275\u0275conditionalCreate(17, EarConsultationsList_ng_template_13_Conditional_17_Template, 3, 0, "button", 21);
    \u0275\u0275conditionalCreate(18, EarConsultationsList_ng_template_13_Conditional_18_Template, 2, 0, "span", 22);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(19, "td", 18)(20, "button", 23);
    \u0275\u0275listener("click", function EarConsultationsList_ng_template_13_Template_button_click_20_listener() {
      const consultation_r4 = \u0275\u0275restoreView(_r2).$implicit;
      const ctx_r4 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r4.openEditConsultation(consultation_r4));
    });
    \u0275\u0275element(21, "i", 24);
  ...
  if (rf & 2) {
    ...
    const ctx_r4 = \u0275\u0275nextContext();
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(consultation_r4.applicantFileNumber);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(consultation_r4.consultationType || "\u063A\u064A\u0631 \u0645\u062D\u062F\u062F");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(consultation_r4.referralReason || "\u063A\u064A\u0631 \u0645\u062D\u062F\u062F");
    \u0275\u0275advance(2);
    \u0275\u0275classMap(ctx_r4.getBadgeClass(consultation_r4.result));
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", consultation_r4.result || "\u063A\u064A\u0631 \u0645\u062D\u062F\u062F", " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate((consultation_r4.doctor == null ? null : consultation_r4.doctor.fullName) || "\u063A\u064A\u0631 \u0645\u062D\u062F\u062F");
    \u0275\u0275advance(2);
    \u0275\u0275conditional(consultation_r4.attachment ? 17 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(!consultation_r4.attachment ? 18 : -1);
  }
}
function EarConsultationsList_ng_template_14_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "tr")(1, "td", 27)(2, "div", 28);
    \u0275\u0275element(3, "i", 29);
    \u0275\u0275elementStart(4, "span", 30);
    \u0275\u0275text(5, "\u0644\u0627 \u062A\u0648\u062C\u062F \u0627\u0633\u062A\u0634\u0627\u0631\u0627\u062A");
    \u0275\u0275elementEnd()()()();
  }
}
var EarConsultationsList = class _EarConsultationsList {
  service;
  toastr;
  modalService;
  consultations = [];
  ...
  loadConsultations() {
    ...
    this.service.getEarClinicConsultations(this.page, this.rowsPerPage, filter).subscribe((res) => {
  ...
  openEditConsultation(consultation) {
    ...
    modalRef.componentInstance.consultationUpdated.subscribe((updated) => {
      if (updated) {
        const index = this.consultations.findIndex((c) => c.consultationID === consultation.consultationID);
        if (index !== -1) {
          this.consultations[index] = __spreadValues(__spreadValues({}, this.consultations[index]), consultation);
  ...
  static \u0275fac = function EarConsultationsList_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _EarConsultationsList)(\u0275\u0275directiveInject(EarClinicExamService), \u0275\u0275directiveInject(ToastrService), \u0275\u0275directiveInject(NgbModal));
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _EarConsultationsList, selectors: [["app-ear-consultations-list"]], viewQuery: function EarConsultationsList_Query(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275viewQuery(_c0, 5);
      \u0275\u0275viewQuery(_c1, 5);
    }
  ...
  }, decls: 16, vars: 7, consts: [["searchInput", ""], ["table", ""], [1, "user-header-section", "p-3", "container-fluid"], [1, "mb-3"], [1, "table-toolbar", "mb-3"], [1, "filter-reset-wrapper"], [3, "reset"], [1, "search-wrapper"], ["type", "text", "placeholder", "\u0627\u0628\u062D\u062B \u0639\u0646 \u0631\u0642\u0645 \u0627\u0644\u0645\u0644\u0641 \u0623\u0648 \u0627\u0644\u0646\u062A\u064A\u062C\u0629", 1, "search-input", 3, "input"], [1, "fas", "fa-search", "search-icon"], [1, "custom-table", "my-3", 3, "value", "loading", "tableStyle"], ["pTemplate", "header"], ["pTemplate", "body"], ["pTemplate", "emptymessage"], [3, "pageChange", "pageSizeChange", "totalRecords", "pageSize", "currentPage"], [1, "text-center", 2, "min-width", "120px"], [1, "text-center", 2, "min-width", "150px"], [1, "text-center", 2, "min-width", "100px"], [1, "text-center", "align-middle"], [1, "fw-bold", "small"], [1, "small"], ["type", "button", "title", "\u0641\u062A\u062D \u0627\u0644\u0645\u0644\u0641", 1, "btn", "btn-sm", "btn-outline-secondary"], [1, "text-muted", "small"], ["type", "button", "title", "\u0625\u0636\u0627\u0641\u0629 \u0646\u062A\u064A\u062C\u0629", 1, "btn", "btn-sm", "btn-outline-secondary", 3, "click"], [1, "pi", "pi-pen-to-square"], ["type", "button", "title", "\u0641\u062A\u062D \u0627\u0644\u0645\u0644\u0641", 1, "btn", "btn-sm", "btn-outline-secondary", 3, "click"], [1, "bi", "bi-file-earmark-text", "me-1"], ["colspan", "7", 1, "text-center", "py-4"], [1, "d-flex", "flex-column", "align-items-center"], [1, "pi", "pi-comments", "text-muted", "mb-2", 2, "font-size", "2rem"], [1, "text-muted"]], template: function EarConsultationsList_Template(rf, ctx) {
    if (rf & 1) {
      const _r1 = \u0275\u0275getCurrentView();
      \u0275\u0275elementStart(0, "div", 2)(1, "h4", 3);
      \u0275\u0275text(2, "\u0637\u0644\u0628\u0627\u062A \u0627\u0644\u0627\u0633\u062A\u0634\u0627\u0631\u0627\u062A \u0627\u0644\u062E\u0627\u0631\u062C\u064A\u0629");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(3, "div", 4)(4, "div", 5)(5, "app-reset-filters-button", 6);
      \u0275\u0275listener("reset", function EarConsultationsList_Template_app_reset_filters_button_reset_5_listener() {
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView(ctx.resetFilters());
      });
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(6, "div", 7)(7, "input", 8, 0);
      \u0275\u0275listener("input", function EarConsultationsList_Template_input_input_7_listener($event) {
        \u0275\u0275restoreView(_r1);
      ...
      \u0275\u0275template(12, EarConsultationsList_ng_template_12_Template, 15, 0, "ng-template", 11)(13, EarConsultationsList_ng_template_13_Template, 23, 9, "ng-template", 12)(14, EarConsultationsList_ng_template_14_Template, 6, 0, "ng-template", 13);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(15, "app-paginator", 14);
      \u0275\u0275listener("pageChange", function EarConsultationsList_Template_app_paginator_pageChange_15_listener($event) {
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView(ctx.onPageChange($event));
      })("pageSizeChange", function EarConsultationsList_Template_app_paginator_pageSizeChange_15_listener($event) {
        \u0275\u0275restoreView(_r1);
  ...
  >\r
    <ng-template pTemplate="header">\r
      <tr>\r
        ...
        <th style="min-width:150px" class="text-center">\u0646\u0648\u0639 \u0627\u0644\u0627\u0633\u062A\u0634\u0627\u0631\u0629</th>\r
        <th style="min-width:150px" class="text-center">\u0633\u0628\u0628 \u0627\u0644\u0625\u062D\u0627\u0644\u0629</th>\r
...
\r
    <ng-template pTemplate="body" let-consultation>\r
      <tr>\r
        <td class="text-center align-middle">\r
          <span class="fw-bold small">{{ consultation.applicantFileNumber }}</span>\r
        </td>\r
        <td class="text-center align-middle">\r
          <span class="small">{{ consultation.consultationType || '\u063A\u064A\u0631 \u0645\u062D\u062F\u062F' }}</span>\r
        </td>\r
        <td class="text-center align-middle">\r
          <span class="small">{{ consultation.referralReason || '\u063A\u064A\u0631 \u0645\u062D\u062F\u062F' }}</span>\r
        </td>\r
        <td class="text-center align-middle">\r
          <span [class]="getBadgeClass(consultation.result)">\r
            {{ consultation.result || '\u063A\u064A\u0631 \u0645\u062D\u062F\u062F' }}\r
          </span>\r
        </td>\r
        <td class="text-center align-middle">\r
          <span class="small">{{ consultation.doctor?.fullName || '\u063A\u064A\u0631 \u0645\u062D\u062F\u062F' }}</span>\r
        </td>\r
        <td class="text-center align-middle">\r
          @if (consultation.attachment) {\r
            <button \r
              type="button" \r
              class="btn btn-sm btn-outline-secondary" \r
              title="\u0641\u062A\u062D \u0627\u0644\u0645\u0644\u0641"\r
              (click)="openFile(consultation.attachment)">\r
        ...
        <td class="text-center align-middle">\r
          <button \r
            ...
            class="btn btn-sm btn-outline-secondary" \r
            title="\u0625\u0636\u0627\u0641\u0629 \u0646\u062A\u064A\u062C\u0629"\r
            (click)="openEditConsultation(consultation)">\r
      ...
      <tr>\r
        <td colspan="7" class="text-center py-4">\r
          <div class="d-flex flex-column align-items-center">\r
            <i class="pi pi-comments text-muted mb-2" style="font-size: 2rem;"></i>\r
            <span class="text-muted">\u0644\u0627 \u062A\u0648\u062C\u062F \u0627\u0633\u062A\u0634\u0627\u0631\u0627\u062A</span>\r
          </div>\r
        </td>\r
      </tr>\r
    </ng-template>\r
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(EarConsultationsList, { className: "EarConsultationsList", filePath: "src/app/features/doctor/components/ear-doctor.component/ear-consultations-list/ear-consultations-list.ts", lineNumber: 23 });
})();
export {
  EarConsultationsList
};
//# sourceMappingURL=chunk-GXLOY75W.js.map
