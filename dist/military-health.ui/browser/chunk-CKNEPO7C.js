...
function SurgeryConsultationsList_ng_template_7_Template(rf, ctx) {
  if (rf & 1) {
...
function SurgeryConsultationsList_ng_template_8_Conditional_17_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 22);
    \u0275\u0275listener("click", function SurgeryConsultationsList_ng_template_8_Conditional_17_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r3);
...
function SurgeryConsultationsList_ng_template_8_Conditional_18_Template(rf, ctx) {
  if (rf & 1) {
...
function SurgeryConsultationsList_ng_template_8_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(17, SurgeryConsultationsList_ng_template_8_Conditional_17_Template, 3, 0, "button", 19)(18, SurgeryConsultationsList_ng_template_8_Conditional_18_Template, 2, 0, "span");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(19, "td", 18)(20, "button", 20);
    \u0275\u0275listener("click", function SurgeryConsultationsList_ng_template_8_Template_button_click_20_listener() {
...
function SurgeryConsultationsList_ng_template_9_Template(rf, ctx) {
  if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(SurgeryConsultationsList, [{
    type: Component,
    args: [{ selector: "app-surgery-consultations-list", standalone: true, imports: [CommonModule, ButtonModule, FormsModule, TableModule, PaginatorComponent, FilterBarComponent, PageHeaderComponent], template: `<div class="list-page-section">\r
  <app-page-header\r
    variant="banner"\r
    title="\u0627\u0633\u062A\u0634\u0627\u0631\u0627\u062A \u0627\u0644\u0639\u064A\u0627\u062F\u0629 \u0627\u0644\u062C\u0631\u0627\u062D\u064A\u0629"\r
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SurgeryConsultationsList, { className: "SurgeryConsultationsList", filePath: "src/app/features/doctor/components/surgery-doctor.component/surgery-consultations-list/surgery-consultations-list.ts", lineNumber: 23 });
})();
export {
  SurgeryConsultationsList
};
//# sourceMappingURL=chunk-CKNEPO7C.js.map
